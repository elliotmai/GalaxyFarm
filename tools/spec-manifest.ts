...
export const SPEC_COVERAGE: Readonly<Record<string, SpecCoverageEntry>> = {
  ...
  CattleProfile: {
    section: "5.2",
    kind: "entity",
    declares: ["cattleProfileSchema", "breedShareSchema", "registrationSchema"],
    phase: "Phase 1",
    status: "built",
  },
  Pedigree: {
  ...
  WeightRecord: {
    section: "5.2",
    kind: "entity",
    declares: ["weightRecordSchema", "averageDailyGain", "unadjusted205DayWeight"],
    phase: "Phase 1",
    status: "built",
  },
  HealthRecord: {
...
export const NOTIFICATION_COVERAGE: Readonly<
  ...
  >
> = {
  "vaccine/booster due": { derivedFrom: "boosterDue", phase: "Phase 1", status: "built" },
  "withdrawal ending": { derivedFrom: "withdrawalEndDate", phase: "Phase 1", status: "built" },
  "preg check due": { derivedFrom: "pregCheckDue", phase: "Phase 1", status: "built" },
  "calving window opening": { derivedFrom: "calvingWindow", phase: "Phase 1", status: "built" },
  ...
  "bull ring due": { derivedFrom: "ruleDeadlines", phase: "Phase 5", status: "built" },
...
> = {
  ...
  "Under 6 months old at drop-off": { id: "under-six-months", status: "built" },
  "Tagged / visible ID": { id: "visible-id", status: "built" },
  "Bulls ringed by 8 months": { id: "bull-ringed-by-eight-months", status: "built" },
  "Bulls depart by 10 months": { id: "bull-departs-by-ten-months", status: "built" },
  "Heifers/steers depart by 12 months": { id: "depart-by-twelve-months", status: "built" },
  "Behavior termination clause": { id: "behaviour-termination", status: "built" },
  "Owner pays feed & supplies": { id: "owner-pays-consumables", status: "built" },
