...
def mark(size=26):
    ...
    return (f'<svg viewBox="0 0 100 100" width="{size}" height="{size}" aria-hidden="true" '
            ...
            f'<path d="M12 78 Q50 98 88 78" fill="none" stroke="var(--primary)" '
            f'stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/>'
            f'<polygon points="{star}" fill="var(--ink)" stroke="var(--ink)" stroke-width="5" '
            f'stroke-linejoin="round" transform="translate(40 42) scale(0.7059) translate(-50 -50)"/>'
            f'<polygon points="{star}" fill="var(--ink)" stroke="var(--ink)" stroke-width="5" '
            f'stroke-linejoin="round" transform="translate(72 62) scale(0.3676) translate(-50 -50)"/>'
            f'</svg>')
